...
// Thu Feb 17 16:00:26 2011 by ROOT version 5.27/04
// from TTree herald/Data from herald file
// found on file: herald.root
//////////////////////////////////////////////////////////

#ifndef TMapSelector_h
#define TMapSelector_h
...
class TMapSelector : public TSelector {
public :
   Int_t           fJ;
   Int_t           fCount;
   THealpixMap*    fMap;
   ...
   TMapSelector(TTree * /*tree*/ = 0) { }
   virtual ~TMapSelector() { }
   ...
   ClassDef(TMapSelector,0); // Selector to build a Healpix map.
};

#endif

#ifdef TMapSelector_cxx
void TMapSelector::Init(TTree *tree)
{
