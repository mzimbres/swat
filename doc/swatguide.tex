...
\begin{itemize}
\item The program simulates n skies.
\item For each sky simulated the analysis made by swatfind is used to calculate the
correlation coefficinent, for the largest wavelet coefficient found.
\item If the correlation is larger than C , passed with option -c and has more than n evnets, passed 
...
A root file is generated, which contains two histograms:
\begin{enumerate}
